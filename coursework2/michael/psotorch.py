...
class PSO(Optimizer):
    ...
    def step(self, closure=None):
        ...
        self.positions += (self.inertia * self.velocities) + np.multiply(a1r1, best_particle_dif) + np.multiply(a2r2, best_swarm_dif)
    ...
    def update_model_weights(self, new_position):
        ...
        for name, param in self.model.named_parameters():
            ...
            new_layer_len = prod([i for i in param.size()])
