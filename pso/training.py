...
class TrainingInstance:
    ...
    def __init__(self, x_train, y_train, network_structure, inertia, a1, a2, population_size, search_space, epochs, seed, nonlinearity_keys=None, x_val=None, y_val=None, cache_loc=Path(
        "/home/mclancy/Documents/notes/edinburgh/year4/naturalcomputing/coursework/data/cache/"), device="cpu", verbose=False):
